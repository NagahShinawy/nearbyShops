...
SECRET_KEY = 'qx*v)#^(tv+4dm_9ptber3h+t&=a4z(9z)n#c!u4k6km23+03z'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'geoshops',
        # 'USER': 'postgres',  (default db user)
        'USER': 'shopadmin',   # new db user that i already created (docs.txt)
        'PASSWORD': 'root',
        'HOST': 'localhost',
        'PORT': '5432',
    }
...
LOCAL = os.path.dirname(BASE_DIR)   # D:\containers\learn-projects\django-courses\nearbyShop
